            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbar-main">
                    <ul class="navbar-nav m-auto padding-ul text-center mx-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link font-weight-bold rounded-2 fs-5 no_wrap" href="solutions.html">Our Solutions</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link font-weight-bold rounded-2 fs-5 no_wrap" href="success.html">Success Stories</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link font-weight-bold rounded-2 fs-5 no_wrap" href="donation.html">Donate Now</a>
                        </li>
                    </ul>
                    <a class="text-decoration-none link-secondary my-sm-0" href="problem_simulation.html">
