...
<html lang="en">
  ...
  <body>
    ...
    <main class="container mt-5">
        ...
        <div class="row  px-3 py-5">
          ...
          <div class="col-md-4 text-center">
            <a href="https://www.human-i-t.org/" class="bg-white" target="_blank">
              <button type="button" class="btn" data-bs-toggle="tooltip" data-bs-custom-class="custom-tooltip" data-bs-placement="top" data-bs-title="Transform Unwanted Technology into Opportunities for People In-Need">
          ...
          <div class="col-md-4 text-center mt-2">
            <a href="https://www.itschoolsafrica.org/" target="_blank" class="bg-white a-hover">
              <button type="button" class="btn" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" data-bs-title="Provides e-Learning technology to improve life opportunities for school students and local communities in Africa and the UK">
                <img src="./media/images/itschoolsafrica.png" alt="IT schools Africa logo" class="img-fluid img-hover">
              </button>
            </a>
          </div>
          <div class="col-md-4 text-center">
            <a href="https://comprenew.org" class="bg-white" target="_blank">
              <button type="button" class="btn" data-bs-toggle="tooltip" data-bs-custom-class="custom-tooltip" data-bs-placement="top" data-bs-title="Protect businesses, people and the environment from the threat of improperly disposed electronic">
        ...
        <div class="row">
          <div class="col-md-4 text-center">
            <a href="https://www.compudopt.org" target="_blank" class="bg-white">
              <button type="button" class="btn" data-bs-toggle="tooltip" data-bs-custom-class="custom-tooltip" data-bs-placement="bottom" data-bs-title="Provide technology access and education to under-resourced youth and their communities.">
          ...
          <div class="col-md-4 text-center">
            <a href="https://www.computeraid.org/" class="bg-white" target="_blank">
              <button type="button" class="btn" data-bs-toggle="tooltip" data-bs-custom-class="custom-tooltip" data-bs-placement="bottom" data-bs-title="Build a world where everyone has access to technology.">
                <img src="./media/images/computeraid_logo.png" alt="Computeraid logo" class="img-fluid img-hover">
              </button>
            </a>
          </div>
          <div class="col-md-4 text-center mb-5">
            <a href="https://rrrcomputer.org" class="bg-white" target="_blank">
              <button type="button" class="btn" data-bs-toggle="tooltip" data-bs-custom-class="custom-tooltip" data-bs-placement="bottom" data-bs-title="Facilitates School Laptop Donations">
                <img src="./media/images/RRRComputer.png" alt="RRRComputer logo" class="img-fluid img-hover">
              </button>
            </a>
          </div>
        </div>
      ...
      <form id="donation-form" method="POST" action="">
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control rounded-3" id="first-name" name="first-name" required />
          </div>
          <div class="col-md-6 mb-3">
            <label for="last-name" class="form-label">Last Name*</label>
            <input type="text" class="form-control rounded-3" id="last-name" name="last-name" required />
          </div>
          <div class="col-md-6 mb-3">
          ...
          <div class="col-md-6 mb-3">
            ...
            <div class="col-md-12 mb-3">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control" id="donation-amount" name="donation-amount" required />
            ...
            <div class="col-md-12 mb-3">
              ...
              <input type="text" class="form-control rounded-3" id="card-number" name="card-number" required />
            </div>
            <div class="col-md-6 mb-3">
              <label for="expiration-date" class="form-label">Expiration Date*</label>
              <input type="month" class="form-control rounded-3" id="expiration-date" name="expiration-date" required />
            </div>
            <div class="col-md-6 mb-3">
              <label for="security-code" class="form-label">Security Code*</label>
              <input type="text" class="form-control rounded-3" id="security-code" name="security-code" required />
            </div>
            <div class="col-md-12 my-3">
              <h2>Donate an Electronic Device (Optional)</h2>
              <hr />
              <p>If you have an electronic device you would like to donate, please fill out the information below:</p>
            </div>
              <div class="col-md-6 mb-3">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="number" class="form-control rounded-3" id="device-age" name="device-age" min="0" max="99" />
              </div>
              <div class="col-md-6 mb-3">
                <label for="device-description" class="form-label">Description</label>
                <textarea class="form-control rounded-3" id="device-description" name="device-description" rows="3"></textarea>
              </div>
            </div>
      ...
      <div class="modal fade" id="confirmation-modal" tabindex="-1" role="dialog" aria-labelledby="confirmation-modal-label" aria-describedby="confirmation-modal-content" aria-modal="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="cancel-donation">Cancel</button>
              <button type="button" class="btn btn-primary" id="confirm-donation-button">Confirm Donation</button>
            </div>
          </div>
        </div>
      </div>
        ...
        $(document).ready(function() {
          $('#donation-form').submit(function(event) {
            ...
            if (parseInt($('#donation-amount').val()) > 1000) {
              console.log($('#donation-amount').val());
