...
<html>
    <head>
        <title>E-Waste Awareness | About Us</title>
        <meta charset="utf-8">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light bg-body-tertiary">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav m-auto padding-ul text-center mx-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link font-weight-bold rounded-2 fs-5no_wrap " href="donation.php">Donate Now</a>
                        </li>
                    </ul>
                ...
                <section>
                    <div class="container col-xxl-8 mb-5 py-5">
                        <div class="row flex-lg-row-reverse align-items-center g-5">
                            <div class="col-lg-15">
                                <h2 class="display-6 fw-bold lh-1 mb-3 text-center">
                                    About Us
                                </h2>
                                <p class="lead">
