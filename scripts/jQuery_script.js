...
function create_img(eWaste_div) {
    ...
    img.style.top = getRndInteger(0, eWaste_div.offsetHeight - img.height) + "px";
    img.style.left = getRndInteger(0, eWaste_div.offsetWidth - img.width) + "px";
    return img;
}
